...
% if i have enough space i will add this
% \section{SQUID practical applications}
%  put here the basic components a squid is made of
% \subsection{The SQUID gradiometer}
% some nice pictures from a SCEM
% \subsection{The qubit}

% \subsection{Transition-edge sensors}
% Blab about the research being done in this field
